...
export const PART4_SECTIONS: Part4SectionDef[] = [
  {
    ...
    rows: [
      ...
      { no: 39, label: "Less: Optional Standard Deduction (OSD)" },
      { no: 40, label: "Net Income from Operation / Gross Taxable Income" },
      { no: 41, label: "Add: Other Income (specify) — row 1" },
      { no: 42, label: "Add: Other Income — row 2" },
      { no: 43, label: "Total Income (Items 40 + 41 + 42, if applicable)" },
      { no: 44, label: "Less: Non-taxable / Exempt (if applicable)" },
      { no: 45, label: "Taxable Income (Graduated) — before tax" },
      { no: 46, label: "TAX DUE (Graduated) — (To Part II, Item 20)" },
    ],
  },
  {
    id: "IV.B",
    ...
    rows: [
      ...
      { no: 50, label: "Add: Other Non-Operating Income" },
      { no: 51, label: "Total (Items 49 + 50)" },
      { no: 52, label: "Less: Allowable reduction (e.g. first ₱250,000, if applicable)" },
      { no: 53, label: "Taxable Income (8%)" },
      { no: 54, label: "Income Tax Due at 8% (before credits)" },
      { no: 55, label: "Adjustments / Other (specify, if applicable)" },
      { no: 56, label: "TAX DUE (8%) — (To Part II, Item 20)" },
    ],
  },
  {
    id: "IV.C",
    ...
    rows: [
      ...
      { no: 59, label: "Creditable Tax Withheld for the Quarter" },
      { no: 60, label: "Creditable Tax Withheld on Income Payments Subjected to Final Withholding Tax" },
      { no: 61, label: "Foreign Tax Credits (if applicable)" },
      { no: 62, label: "Tax Paid in Return Previously Filed (if amended)" },
      { no: 63, label: "Other Tax Credits / Payments (specify)" },
      { no: 64, label: "Total Tax Credits / Payments — (To Part II, Item 21)" },
    ],
  },
  {
    id: "IV.65",
