...
This payment is for professional tax filing assistance services only.
It does not include government taxes, penalties, or filing fees.

What happens next
To proceed with your tax filing review, please upload the required documents using the secure link below:

Upload Documents: ${v.uploadLink}
...
Kind regards,
${v.yourName || "Reiner"}
${v.businessName || config.siteName}
`;
  return { subject, body };
}
...
We’re writing to inform you that your tax filing assistance service for Order ${v.orderId} has been completed.
...
Next steps:
Please review the outputs/instructions provided. You remain responsible for the final filing and submission of your tax return and any payment due to the Bureau of Internal Revenue (BIR).
